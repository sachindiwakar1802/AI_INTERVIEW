                    ...
                    <div className='space-y-5'>
                        {[
                            ...
                            <motion.div 
                                ...
                                className='flex items-center space-x-4 bg-white p-4 rounded-xl shadow-sm cursor-pointer active:bg-gray-50'
                    ...
                    <div className='space-y-6'>
                        ...
                        {!analysisDone && (
                            <motion.div
                                ...
                                className='border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transition active:bg-green-100'
                                style={{ minHeight: '44px' }}>
                                ...
                                <input 
                                    ...
                                    onChange={(e) => {
                                        ...
                                        if (isMobile && e.target.files[0]) {
                                            setTimeout(() => handleUploadResume(), 100);
                                        }
                                    }} />

                                <p className='text-gray-600 font-medium'>
                                    {resumeFile ? resumeFile.name : "Tap to upload resume (Optional)"}
                                </p>
                                ...
                                {resumeFile && isMobile && (
                                    <div
                                        ...
                                        className='mt-4 bg-gray-900 text-white px-5 py-2 rounded-lg inline-block active:bg-gray-700'
                                        style={{ minHeight: '44px', minWidth: '44px' }}>
                                        {analyzing ? "Analyzing..." : "Analyze Resume"}
                                    </div>
                                )}
                        ...
                        <motion.button
                            onClick={handleStart}
                            disabled={!role || !experience || loading}
                            whileHover={!isMobile && !(!role || !experience || loading) ? { scale: 1.03 } : {}}
                            whileTap={isMobile && !(!role || !experience || loading) ? { scale: 0.95 } : {}}
