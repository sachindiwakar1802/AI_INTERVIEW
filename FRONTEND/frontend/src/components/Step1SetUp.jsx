...
import { ServerUrl } from '../App';  // Make sure this is only here ONCE
                            ...
                            <div className='border-2 border-dashed border-gray-300 rounded-xl p-8 text-center'>
                                ...
                                <label 
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition">
                                        ...
                                        {analyzing && (
                                            <div className="mt-2">
                                                <p className="text-green-600">Analyzing resume...</p>
                                ...
                                {!analyzing && resumeFile && !analysisDone && (
                                    <button
                                        onClick={() => handleUploadResume(resumeFile)}
                        ...
                        {analysisDone && (
                            <div className='bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-4'>
                                ...
                                {projects.length === 0 && skills.length === 0 && (
                                    <p className="text-gray-500">No projects or skills found in resume</p>
                                )}
                            </div>
                        )}
